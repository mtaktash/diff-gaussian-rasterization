...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color, radii, geomBuffer, binningBuffer, imgBuffer, depth, weight = (
            ...
            num_rendered, color, radii, geomBuffer, binningBuffer, imgBuffer, depth, weight = _C.rasterize_gaussians(
                *args
            )
        ...
        return color, radii, depth, weight
